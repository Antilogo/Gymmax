            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="{{route('category.edit', ['id' =>$item->category_id])}}" class="btn btn-primary">Change</a>
                  <a onclick="return confirm('Bạn có chắc muốn xóa Category ?')" href="{{route('category.delete', ['id' =>$item->category_id])}}" class="btn btn-primary">Delete</a>
