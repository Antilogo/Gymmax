        ...
        <div id="page-inner">
            <form action="" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="category_name"  placeholder="Category Name" value="{{old('category_name') ?? $data->category_name}}">
                  @error('category_name')
                ...
                <a href="{{route('category.categorydashboard')}}" class="btn btn-warning">
                    Back
                  </a>
